...
const services = [
  {
    ...
    description:
      "Custom illuminated 3D letters that make your business stand out day and night. LED-lit, durable, and designed for maximum visibility.",
    icon: "🏢",
  ...
  },
  {
    ...
    description:
      "High-resolution large format printing for banners, posters, displays, and promotional materials with vibrant, lasting colors.",
    icon: "🖨️",
  ...
  },
  {
    ...
    title: "Truck Signs",
    description:
      "Transform your commercial vehicles into mobile billboards. Professional graphics that turn heads and generate leads on the road.",
    icon: "🚛",
    slug: "truck-signs",
  },
  {
    ...
    title: "Car Wraps",
    description:
      "Full and partial vehicle wraps for personal and commercial vehicles. Premium vinyl, expert installation, stunning results.",
    icon: "🚗",
    slug: "car-wraps",
  },
  {
    ...
    description:
      "Premium business cards that leave lasting impressions. Multiple finishes including matte, gloss, and metallic options.",
    icon: "💼",
    slug: "business-cards",
  },
  {
    ...
    title: "Yard Signs",
    description:
      "Durable corrugated signs perfect for real estate, events, political campaigns, and temporary promotions.",
    icon: "📍",
    slug: "yard-signs",
  },
  {
    ...
    description:
      "Eye-catching vinyl banners and full-color flyers for events, sales, and marketing campaigns of any scale.",
    icon: "🎯",
    slug: "flyers-banners",
  },
  {
    ...
    description:
      "Custom apparel printing for businesses, events, and promotional merchandise. Screen printing and DTG available.",
    icon: "👕",
  ...
  },
  {
    ...
    description:
      "Complete branding solutions including storefronts, interior graphics, window displays, and corporate environments.",
    icon: "✨",
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="body-premium text-muted-foreground max-w-2xl mx-auto animate-fade-up delay-200">
              From vehicle wraps to commercial signage, we deliver premium
              branding solutions that transform your vision into powerful visual
              experiences.
            </p>
          </div>
        </div>
            ...
            {[
              {
                step: "01",
                title: "Consult",
                desc: "Share your vision and requirements",
              },
              {
                step: "02",
                title: "Design",
                desc: "We create custom concepts",
              },
              {
                step: "03",
                title: "Produce",
                desc: "Premium materials & printing",
              },
              {
                step: "04",
                title: "Install",
