      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <Link to={`/services/${service.slug}`} key={index} className="service-card group block">
              {/* Image */}
              ...
              <div className="p-6 bg-gradient-to-t from-card to-card/80">
                ...
                <p className="body-premium text-muted-foreground text-sm">{service.description}</p>
